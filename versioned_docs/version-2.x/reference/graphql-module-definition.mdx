...
[meta module](/docs/2.x/advanced/graphql/meta-modules). It allows to declare the
...
- `makeDataLoader`: a factory to build a dataloader (see
  [`makeDataLoader` usage](/docs/2.x/advanced/graphql/dataloaders-and-cache-invalidation#makedataloader-usage))
...
[remote schema stitching in Front-Commerce](/docs/2.x/advanced/graphql/remote-schemas).
...
[the dedicated documentation section](/docs/2.x/advanced/graphql/remote-schemas#default-transforms)
...
[default transforms](/docs/2.x/advanced/graphql/remote-schemas#default-transforms).
...
[`makeExecutor` helper](/docs/2.x/reference/remote-schema-helpers#makeexecutor)
...
[GraphQL Context](/docs/2.x/reference/graphql-context) (even if they share the
same term!).
...
[Front-Commerce GraphQL context](/docs/2.x/reference/graphql-context) so they
