...
[`FRONT_COMMERCE_UNSAFE_INSECURE_MODE` environment variable](/docs/2.x/reference/environment-variables#host).
...
[the customize manifest.json guide](/docs/2.x/advanced/theme/manifest-json).
