...
[Add the mapping between the type and the page component](/docs/2.x/advanced/theme/route-dispatcher#add-the-mapping-between-the-type-and-the-page-component)
