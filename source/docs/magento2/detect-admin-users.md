...
In Front-Commerce, we have a way to let you know whether the user is an admin or not. We've achieved this by injecting something into the user's session when they are navigating Magento's backend. This documentation page details how it works and how you can use it.
