...
- Access to the Big Commerce Graph:
  - `FRONT_COMMERCE_BIG_COMMERCE_GRAPH_TOKEN` contains the GraphQL token
    generated by following
    [the create a Customer impersonation tokens guide](https://developer.bigcommerce.com/docs/ZG9jOjIyMDczOQ-overview#customer-impersonation-tokens)
  - `FRONT_COMMERCE_BIG_COMMERCE_GRAPH_ENDPOINT` contains the URL of the Graph
    endpoint for your store e.g. something like
    `https://my-bc-store.mybigcommerce.com/graphql`
