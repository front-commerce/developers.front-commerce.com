...
> This updates includes some bug fixes and improvements to the core.
> Notably, new packages such as `@front-commerce/magento1`, `@front-commerce/adyen` and `@front-commerce/akamai-image-manager` are now available.
> The Magic Button and Contribution technical foundations have been revamped to embrace Web standards.
