...
refer to [React components structure](/docs/concepts/react-components-structure)
first.
...
Front-Commerce also
[provides a `<Map>` component](/docs/advanced/features/display-a-map) that would
...
replace your components with the `<Map>` one.
...
[`config/website.js`'s `contentSecurityPolicy`
key]/docs/reference/configurations#configwebsitejs) (i.e: define
...
[Storybook guide](/docs/essentials/add-component-to-storybook) to learn how to
add any kind of stories to your Storybook.
