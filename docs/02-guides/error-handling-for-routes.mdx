---
title: Error Handling for routes
description:
...
To extend the meta tags for your route error pages, you can register new meta
tags in the
[`root-error-meta`](/docs/3.x/api-reference/front-commerce-remix/features#root-error-meta)
feature.

### Adding Custom Meta Tags

You can refer to the
[example demo extension](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/blob/a025ba1e1ba82a4a56609e58d537d03d74317df3/skeleton/example-extensions/error-boundary-demo/index.ts)
               ...
               messages: () => {
                  return (intl: IntlShape) => {
                     "500": {
                        ...
                        title: intl.formatMessage({ id: "500.title" }),
                        description: intl.formatMessage({ id: "500.description" }),
                     },
                     "418": {
...
Front-Commerce provides default meta tags for common status codes: (_see
exhaustive list in
[`root-error-meta.ts`](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/blob/a025ba1e1ba82a4a56609e58d537d03d74317df3/packages/theme-chocolatine/features/root-error-meta.ts)_)
