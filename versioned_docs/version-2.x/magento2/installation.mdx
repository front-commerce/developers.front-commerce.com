...
The Magento2 module is compatible with Magento2 2.3.2 to 2.4.5-p1 (Open Source,
Commerce and B2B). To use respectively Commerce or B2B specific features, you
...
To check that everything works, you can try to request this URL:
