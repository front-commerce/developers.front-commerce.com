...
[Essentials](/docs/essentials/installation) of Front-Commerce and that you've
registered a method in your backend (Magento2…).
...
- The `SubmitShippingMethod` component is a common component accross all
  shipping methods to ensure consistency in how methods are managed.
...
select a pickup. See
[Add a shipping method with pickup points](/docs/advanced/shipping/add-new-shipping-data-in-graphql)
