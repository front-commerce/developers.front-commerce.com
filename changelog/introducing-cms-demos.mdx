...
### [A GraphQL module](/docs/essentials/extend-the-graphql-schema)
...
### [A theme extension](/docs/essentials/extend-the-theme)
...
[the pages](/docs/essentials/add-a-page-client-side) and
[components](/docs/essentials/create-a-business-component) depending on the new
schema provided by the GraphQL module. However, this is not a full rewrite. Any
component that already existed in Front-Commerce can be reused (simple ones like
links, buttons, etc. and complex ones like ProductItems, MiniCart, etc.).
...
to your [`.front-commerce.js`](/docs/reference/front-commerce-js). A one line
change that brings a complete blog to your shop.
