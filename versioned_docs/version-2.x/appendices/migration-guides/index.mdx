...
```
npm install git+ssh://git@gitlab.blackswift.cloud/front-commerce/front-commerce.git#2.32.0
```
...
<>
  ...
  as it led to blocking network requests that could reduce the <abbr title="Largest Contentful Paint">
    LCP
  </abbr> / <abbr title="First Contentful Paint">FCP</abbr>
</>
