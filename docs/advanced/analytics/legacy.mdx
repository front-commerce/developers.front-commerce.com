...
description: This documentation covers the analytics usage for Front-Commerce versions before 2.19 and in legacy mode.
---
...
upgrade your Analytics config and write new plugins.
