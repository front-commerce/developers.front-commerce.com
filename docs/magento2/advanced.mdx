...
created by the `Magento2/Cart` GraphQL module (see for instance [the
initialization of the `StoreCredit`
loader](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/blob/10a4e81004d0b5b331bdb62b96b1a6daf3e66788/src/server/modules/magento2-commerce/store-credit/index.js#L31))
