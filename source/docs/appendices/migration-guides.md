...
However, for existing shops, you need to check a few things in order to make sure that the wishlist is available for your customers.
...
2. Check that the user can actually add the product to their wishlist
