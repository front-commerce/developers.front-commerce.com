...
[the `req` object is available in the `contextEnhancer`](/docs/reference/graphql-module-definition#contextenhancer-optional).
...
[`config` folder of your project's module](/docs/reference/configurations). If
you have specific needs, please <ContactLink />.
