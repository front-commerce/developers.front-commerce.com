...
- the Payline environment is now fetched from the Magento configuration in the
  [Magento1 payment module](/docs/2.x/advanced/payments/payline#magento1-openmagelts-module)
...
[Upgrade to Front-Commerce 2.10.0](/docs/2.x/appendices/migration-guides#290---2100)
or
