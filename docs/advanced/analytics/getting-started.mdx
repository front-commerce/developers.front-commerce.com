...
Front-Commerce uses [`analytics`](https://getanalytics.io/) under the
hood. If we represent how it works, it would look like this:
...
Components, adding new tracking services is less risky: it has no impact on what is being tracked.
