...
External login rely on redirections, and in development your server is usually at
...
service will provide a publicly accessible URL to your local server. So to
