...
- are displayed using
  [the `<WysiwygV2>` component and its related `WysiwygFragment` GraphQL fragment](/docs/2.x/advanced/theme/wysiwyg#wysiwygv2--usage)
...
<b>Congratulations! 🥳</b> You now have a fully functional Dynamic PageBuilder
Image 💅
