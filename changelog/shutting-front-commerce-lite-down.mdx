...
[the best eCommerce storefront solution for production use](/docs/2.x/category/production-ready)
...
developers to browse [Front-Commerce's documentation](/docs/2.x/welcome) and see
...
- do you struggle to see how you could keep your theme up-to-date across
  ...
  [React theme overrides and fallbacks](/docs/2.x/essentials/extend-the-theme)
...
- are you tired of ever-changing architectural choices in other solutions?
  ...
  [GraphQL implementation is thus extremely modular and extensible](/docs/2.x/essentials/extend-the-graphql-schema).
- wondering about
  [how to configure analytics tracking in a React application?](/docs/2.x/category/analytics)
  Documented too!
- struggling with
  [integrating rich content from a CMS with a rich WYSIWYG or Page Builder?](/docs/2.x/advanced/theme/wysiwyg)
  Many Front-Commerce projects in production are already doing it!
- is security your thing?
  [We have docs for you!](/docs/2.x/advanced/graphql/rate-limiting)
- are you worried about our backward-compatibility policy? We hope that
  [our migration guides](/docs/2.x/appendices/migration-guides) will make you
  feel how committed we are to make your upgrades as seamless as possible.
