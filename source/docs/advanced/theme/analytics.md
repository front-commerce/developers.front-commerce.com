...
id: analytics
title: Analytics
description: Most e-commerce website need advanced analytics to better understand their users and adapt their shops to their customers needs. But it can often be tedious to maintain when you have many trackings to manage. Here is how we integrated analytics services in Front-Commerce.
---

Front-Commerce uses [`analytics.js`](https://segment.com/docs/sources/website/analytics.js/) under the hood. It is a library created by [Segment.io](https://segment.com/) that aims at decoupling the tracking settings from the event.
