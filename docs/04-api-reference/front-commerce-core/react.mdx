...
Returns the public config of the Front-Commerce instance.
...
The same as `usePublicConfig` it returns the public config of the Front-Commerce
instance, this can be used outside of a react scope.
