...
**Front-Commerce [`2.25.0`](#2250-2023-07-05)**

Compatible with:

- **Node.js:**: 16.13+ or 18.12+
- **Magento2**: 2.3.2 -> 2.4.5-p2 (Open Source & Commerce & B2B)
  - Note: Magento 2.4.3 requires
    [this Adobe official patch](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/web-api-resources-limit.html).
