...
Just like any other plugin, don't forget to setup the `cookiesServices.js` file
...
You can use our
[example plugin](https://gitlab.blackswift.cloud/front-commerce/examples/analytics/meta-pixel)
...
[example plugin](https://github.com/front-commerce/examples/analytics/matomo) as
