...
In addition, given [the amount of changes between the version 0.1.7 and
6.2.1](https://github.com/pillarjs/path-to-regexp/compare/v0.1.7...v6.2.1), we
strongly advice you to check [the project
documentation](https://github.com/pillarjs/path-to-regexp/blob/master/Readme.md)
...
still work but will output deprecation messages when used. If you have overridden
