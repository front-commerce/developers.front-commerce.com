...
image: ./assets/Developer_guide_0.png
---

We're happy to announce that we'll be sharing actionable insights with
you about Front-Commerce!

As we get into 2024, we wanted to take a moment to reflect on
our most important release so far: **Front-Commerce Remixed!**

[![Developer Guide: Front-Commerce 2 vs. 3](./assets/Developer_guide_1.png)](/blog/2023-advent-calendar/01-introducing-the-front-commerce-advent-calendar-series)
...
**Small, easy to digest, knowledge bites even when you're on the go.** Regular new
articles that can fit into the busiest of workdays. Keep track of all
