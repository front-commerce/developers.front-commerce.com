...
_Note: in order to follow Semantic Versioning, we'll very likely switch to a 3.x
major version during the year. We'll update the versions accordingly and of
course communicate as soon as we'll have more details._
