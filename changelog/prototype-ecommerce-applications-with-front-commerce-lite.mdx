...
stores. Hence
[our vision](https://developers.front-commerce.com/docs/2.x/welcome) is to
...
[Install Front-Commerce Lite (developers.front-commerce.com)](/docs/2.x/essentials/installation)
