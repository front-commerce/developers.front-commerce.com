...
[our usual release cadence](https://developers.front-commerce.com/docs/2.x/appendices/release-process)
...
[our Adyen connector](https://developers.front-commerce.com/docs/2.x/advanced/payments/adyen)

For our
[PayPal](https://developers.front-commerce.com/docs/2.x/advanced/payments/paypal)
and our
[Lyra](https://developers.front-commerce.com/docs/2.x/advanced/payments/payzen)
...
[the documentation about payments with Front-Commerce!](https://developers.front-commerce.com/docs/2.x/category/payments)
...
[Upgrade to Front-Commerce 2.18.0](/docs/2.x/appendices/migration-guides#2170---2180)
or
