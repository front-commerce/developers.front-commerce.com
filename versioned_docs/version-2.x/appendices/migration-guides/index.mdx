...
[Focal Point](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/40185d3aecd3fd7c7d959483db16cdea21541a82)
support for the `<Image>` component.

**If you use integrated FC Image proxy** the cache needs to be fully
regenerated.
