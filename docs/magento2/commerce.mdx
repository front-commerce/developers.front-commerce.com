...
For now, the Adobe Commerce module only improves the Cms Page handling to
partially expose
...
The Magento2 Commerce improves the Graph to expose the children pages of a Cms
Page. With this module, you can for instance run the following the query:
