...
[Add a new page](/docs/2.x/essentials/add-a-page-client-side). Moreover, to
complete this guide about layouts, you will need to have a module correctly
setup in your project with a
[web module preconfigured](/docs/2.x/essentials/add-a-page-client-side#declare-your-module-as-a-web-module).
...
[`front-commerce-prepare.js:onCreateRoute`](/docs/2.x/reference/front-commerce-prepare#oncreateroute)
