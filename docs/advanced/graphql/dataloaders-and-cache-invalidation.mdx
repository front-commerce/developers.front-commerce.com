...
[module’s `contextEnhancer` function](/docs/reference/graphql-module-definition#contextenhancer-optional).
...
[`config/caching.js` configuration file](/docs/reference/configurations#config-caching-js).
