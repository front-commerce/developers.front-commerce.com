...
[`.front-commerce.js`](/docs/reference/front-commerce-js). However, the modules
that are in `node_modules` won't be linted.
...
[`.front-commerce.js`](/docs/reference/front-commerce-js) configuration file to
