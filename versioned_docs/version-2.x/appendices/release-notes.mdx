...
**Front-Commerce [`2.34.0`](#2340-2024-11-21)**
...
> This release introduces Google Consent Mode V2.

- [Announcement](/changelog/front-commerce-3.9-2.34)
- [Changelog](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/releases/2.34.0)

## 2.33.0 (2024-10-10)

> This release contains newsletter confirmation for Magento1 and several
> bugfixes.

- [Announcement](/changelog/front-commerce-3.8-2.33)
- [Changelog](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/releases/2.33.0)

## 2.32.0 (2024-08-29)

> This release contains order progress visualisation for guests, and several
> bugfixes.

- [Announcement](/changelog/front-commerce-3.7-2.32)
- [Changelog](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/releases/2.32.0)

## 2.31.0 (2024-07-18)

> This release add CVV support for Authorize.net.

- [Announcement](/changelog/front-commerce-3.6-2.31)
- [Changelog](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/releases/2.31.0)
...
Requirements: same as [2.4.0](#240-2021-01-22)
...
Requirements: same as [2.1.0](#210-2020-07-24)
...
>   regression was introduced in [2.0.0](#200-2020-07-09), when we've upgraded a
>   dependency)
...
- [Migration guide](/docs/2.x/appendices/migration-guides/archives#100-alpha2---100-beta0)
...
- [Migration guide](/docs/2.x/appendices/migration-guides/archives#100-alpha1---100-alpha2)
