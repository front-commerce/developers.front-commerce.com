...
[`.front-commerce.js`](/docs/2.x/reference/front-commerce-js) file. If the
...
Please refer to the
[Front-Commerce’s folder structure documentation page](/docs/2.x/concepts/front-commerce-folder-structure)
