---
title: "@front-commerce/magento1/axios"
sidebar_position: 1
description: "Public Axios Api for the magento1 extension"
---
...
The `makeAdminClientFromRequest` function creates an `axios` instance that can be
used to interact with Magento's API as an Admin.
...
The `makeAuthServiceFromRequest` function creates a service that expose related session infos
