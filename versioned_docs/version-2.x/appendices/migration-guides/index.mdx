...
If you've overriden the `OrderShipmentTrackingFragment.gql` file, you must
...
If you've overriden the `BaseTrackingDetails` component, you must add a new
...
- `theme/layouts/GenericLayout.js` ([see the corresponding commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/0378fcceafbd7cb4bf5a1c26e7c9080cdd66fcf7))
- `theme/modules/ProductView/ProductItem/ProductItem.js` ([see the corresponding
    commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/8234c24547b3a22a737f9279ebafddb697135a5e))
- `theme/modules/CmsBlock/CmsBlock.js` ([see the corresponding
    commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/8234c24547b3a22a737f9279ebafddb697135a5e))
- `theme/pages/Product/Product.js` ([see the corresponding
    commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/8234c24547b3a22a737f9279ebafddb697135a5e))
- `theme/pages/Account/Dashboard/Dashboard.js` ([see the corresponding
    commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/8234c24547b3a22a737f9279ebafddb697135a5e))
- `theme/pages/Account/Dashboard/EnhanceDashboard.js` ([see the corresponding
    commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/8234c24547b3a22a737f9279ebafddb697135a5e))
- `theme/pages/Account/Orders/Details/Invoice/Invoice.js` ([see the corresponding
    commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/8234c24547b3a22a737f9279ebafddb697135a5e))
- `theme/pages/Account/Orders/Details/Details.js` ([see the corresponding
    commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/8234c24547b3a22a737f9279ebafddb697135a5e))
- `theme/pages/Product/Product.js` ([see the corresponding
    commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/8234c24547b3a22a737f9279ebafddb697135a5e))
...
- `template/index.html` ([see the corresponding commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/deb16c3af50250b449da80b2ab59eb547296f623#3247326c60e05cf712f07173ced7f41410f2f6b5))
- `theme-chocolatine/web/theme/components/organisms/ItemsSlider/_ItemsSlider.scss` ([see the corresponding commit](https://gitlab.blackswift.cloud/front-commerce/front-commerce/-/commit/0b620671e5af62e1acd8360551e382a3ad2a79e5))
