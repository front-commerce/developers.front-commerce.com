...
We have added support for Google Pay and Apple Pay to our [Adyen integrations](/docs/advanced/payments/adyen), making it easier for customers to make purchases on our platform.

Those were the last 2 payment methods we didn’t support. We’ve updated our documentation to [list the main payment providers supported and tested](/docs/advanced/payments/adyen#payment-methods-support), and are confident that any Adyen payment method is now supported by Front-Commerce.
...
As [teased in our previous changelog entry](/changelog/front-commerce-2.21#weve-been-working-on-something), we’ve been busy working on something new. In 2023, Front-Commerce aims at providing a top-level DX.
...
- **magento2:** we fixed possible SSR errors which could be caused when an incorrect sort parameter was passed in parameters for projects using Magento2 native GraphQL
...
[Upgrade to Front-Commerce 2.22.0](/docs/appendices/migration-guides#2210---2220)
or
