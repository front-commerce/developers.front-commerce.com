...
ship some platform-specific implementations for RMA (so far we have an
implementation for Magento1 Enterprise).
...
To implement an RMA for a new platfom, you have to provide the server
