...
[Extend the GraphQL schema](/docs/2.x/essentials/extend-the-graphql-schema) if
you are ensure how to do so.
...
In case you rely on
[Front-Commerce's caching mechanism](/docs/2.x/advanced/graphql/dataloaders-and-cache-invalidation)
...
your
[Caching strategies](/docs/2.x/advanced/graphql/dataloaders-and-cache-invalidation#permagentoadminrole)
