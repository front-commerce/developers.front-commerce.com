...
integrations listed in the [Payment overview](/docs/category/payments).
...
The frontend will poll for the order status until it becomes successful (the order
has been created by the IPN processor)
