...
requests regarding the product roadmap, do not hesitate to contact Josquin 👋
...
[migration guides for the details](https://developers.front-commerce.com/docs/appendices/migration-guides#2-14-0-gt-2-15-0).
