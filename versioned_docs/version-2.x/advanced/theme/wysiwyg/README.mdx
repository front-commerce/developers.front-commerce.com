...
[the legacy documentation page](/docs/2.x/advanced/theme/wysiwyg/legacy) for
more information about the old behavior.
...
[the next section](/docs/2.x/advanced/theme/wysiwyg-platform#magentowysiwyg).
...
1.  Override `theme/modules/WysiwygV2/appWysiwygComponents.js` and map your new
    ...
    ```js title="theme/modules/WysiwygV2/appWysiwygComponents.js"
