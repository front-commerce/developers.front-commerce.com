...
[read our migration guide](/docs/2.x/appendices/migration-guides/archives/#wishlist-provider)
for further details.
...
version. Our
[migration guide](/docs/2.x/appendices/migration-guides/archives#updated-dependencies)
...
[Upgrade to Front-Commerce 2.6.0](/docs/2.x/appendices/migration-guides/archives#250---260)
or
