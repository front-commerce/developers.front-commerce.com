...
- [Algolia connected to Magento](#algolia-connected-to-magento)
- [Algolia standalone](#algolia-not-connected-to-magento)
- [Attraqt](#attraqt)
...
[to configure the Algolia module](#algolia-not-connected-to-magento).
...
[you also have to configure the Algolia module](#algolia-not-connected-to-magento).
