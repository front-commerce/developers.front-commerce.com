...
description:
  In this section, you will learn how Front-Commerce interacts with your
  different platforms and what is its role.
---

<p>{frontMatter.description}</p>

import Figure from "@site/src/components/Figure";
import ArchitectureOverviewFigure from "./assets/architecture-overview.svg";
import ArchitectureInternalsFigure from "./assets/architecture-internals.svg";
...
Your services do not have to be publicly exposed on the web any more. You could
add firewall rules or networking restrictions so only Front-Commerce’s
middleware is allowed to interact with them.

:::

<Figure>
  <ArchitectureOverviewFigure
    aria-title="Front-Commerce as the central point of a microservice architecture"
    className="text-[#333333] dark:text-white w-full h-auto"
  />
</Figure>
...
<Figure>
  <ArchitectureInternalsFigure
    aria-title="Front-Commerce’s internal architecture: React app, SSR, GraphQL server with caching"
    className="text-[#333333] dark:text-white w-full h-auto"
  />
</Figure>
...
your application domain in a clear and expressive way
[that people can understand](https://www.martinfowler.com/bliki/UbiquitousLanguage.html),
...
Now that you know how Front-Commerce works, you can take try to follow the
[Essentials guides](/docs/2.x/essentials/installation). This will let you know
how common tasks are achieved within Front-Commerce.
