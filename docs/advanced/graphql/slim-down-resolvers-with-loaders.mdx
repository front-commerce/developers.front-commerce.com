...
Please refer to the
[GraphQL module definition reference](/docs/reference/graphql-module-definition#contextenhancer-optional)
...
- using
  [GraphQL modules dependencies](/docs/reference/graphql-module-definition#dependencies-optional)
