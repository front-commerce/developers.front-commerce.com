...
[architectural overview of Front-Commerce](/docs/2.x/concepts/architecture-overview)
...
[get your project started](/docs/2.x/essentials/installation).
...
[Migration guides](/docs/2.x/appendices/migration-guides) to make the process as
