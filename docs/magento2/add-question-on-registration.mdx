...
Here you will learn how to add a `Question` form for the user to fill when
creating an account. You may want to check
[this](/docs/magento2/add-new-attribute) page first, if you don't know how to
add an attribute and create a Front-Commerce module.
...
[first](/docs/magento2/add-new-attribute) part.)
