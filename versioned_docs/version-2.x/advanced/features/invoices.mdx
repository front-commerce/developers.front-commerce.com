...
[Extend the GraphQL schema](/docs/2.x/essentials/extend-the-graphql-schema)_
...
You must implement
[a custom router](/docs/2.x/advanced/server/add-http-endpoint) to expose the PDF
file on a URL. The implementation of this route is up to you and depends on your
context.
