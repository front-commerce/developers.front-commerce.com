...
description: Checkout is one of the most complex parts of any e-commerce website. If you use a relatively standard checkout, you hopefully won't have to change anything more than a few components to adapt them to your look and feel. However, if you add a custom step, you'll need to change a few things.
---
