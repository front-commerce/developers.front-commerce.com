...
[configure Front-Commerce to serve static assets from a different domain](/docs/2.x/advanced/performance/assets-cdn-domain)
...
(Magento1, Magento2, …) in future versions.
