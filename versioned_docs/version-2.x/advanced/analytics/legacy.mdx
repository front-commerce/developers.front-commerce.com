...
(see
[website configurations](/docs/2.x/reference/configurations#configwebsitejs) for
details on why it is important to configure this). To configure the expiration
of the consent cookies you should update `src/config/website.js` as follows:
