...
our first Product Manager, Josquin!** Do not hesitate to contact Josquin with
any requests regarding the Front-Commerce product roadmap, your feedback is
precious 💎
...
We have enhanced our [Smartforms](/docs/advanced/features/smart-forms) solution:
from now on, the postal codes (codes postaux 🇫🇷) of your customers living in
France are displayed by locality with a greater precision, to avoid any
...
> 📨 **Feedback needed:** contact our product manager Josquin to give your
> feedback! [josquin@front-commerce.com](mailto:josquin@front-commerce.com) OR
> [schedule a slot in Calendly](https://calendly.com/josquin-front-commerce/30min)
...
- **[Mondial Relay](/docs/advanced/shipping/mondial-relay):** we now support all
  MondialRelay pickup types (24R, 24L, DRI) in Magento2
...
- **[Prismic](/docs/category/prismic)**: improve resilience on remote Prismic
  errors in case of HTTP errors or timeouts
