...
In this version we've added the list of products shipped in each shipments of an
order.

If you've override the `OrderShipmentTrackingFragment.gql` file, you must inject
a new fragment:
...
If you've override the `BaseTrackingDetails` component, you must add a new
