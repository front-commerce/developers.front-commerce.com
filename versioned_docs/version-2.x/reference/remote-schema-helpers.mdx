...
[Remote GraphQL modules](/docs/reference/graphql-module-definition#executor-optional)
...
[`remoteSchema.executor`](/docs/reference/graphql-module-definition#executor-optional).
